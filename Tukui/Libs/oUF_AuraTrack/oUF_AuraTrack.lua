...
if oUF.Retail then
	...
	-- Shaman
		...
		[49283]   = {0.2, 0.2, 1}, -- Earth Shield(Rank 4)
		[49284]   = {0.2, 0.2, 1}, -- Earth Shield(Rank 5)
		[51945]    = {1.00, 1.00, 1.00}, -- Earthliving(Rank 1)
		[51990]    = {1.00, 1.00, 1.00}, -- Earthliving(Rank 2)
		[51997]    = {1.00, 1.00, 1.00}, -- Earthliving(Rank 3)
		[51998]    = {1.00, 1.00, 1.00}, -- Earthliving(Rank 4)
		[51999]    = {1.00, 1.00, 1.00}, -- Earthliving(Rank 5)
		[52000]    = {1.00, 1.00, 1.00}, -- Earthliving(Rank 6)
		[61295]    = {0, 0, 1.00}, -- Riptide(Rank 1)
		[61299]    = {0, 0, 1.00}, -- Riptide(Rank 2)
		[61300]    = {0, 0, 1.00}, -- Riptide(Rank 3)
		[61301]    = {0, 0, 1.00}, -- Riptide(Rank 4)
		...
		[58771]   = {0.67, 1.00, 0.80}, -- Mana Spring Totem(Rank 6)
		[58773]   = {0.67, 1.00, 0.80}, -- Mana Spring Totem(Rank 7)
		[58774]   = {0.67, 1.00, 0.80}, -- Mana Spring Totem(Rank 8)
		...
		[58751]   = {0.00, 0.00, 0.26}, -- Stoneskin Totem(Rank 9)
		[58753]   = {0.00, 0.00, 0.26}, -- Stoneskin Totem(Rank 10)
		...
		[57622]   = {0.78, 0.61, 0.43}, -- Strength of Earth Totem(Rank 7)
		[58643]   = {0.78, 0.61, 0.43}, -- Strength of Earth Totem(Rank 8)
		[8227]	  = {1.00, 0, 0}, -- Flametongue Totem(Rank 1)
		[8249]	  = {1.00, 0, 0}, -- Flametongue Totem(Rank 2)
		[10526]	  = {1.00, 0, 0}, -- Flametongue Totem(Rank 3)
		[16387]	  = {1.00, 0, 0}, -- Flametongue Totem(Rank 4)
		[25557]	  = {1.00, 0, 0}, -- Flametongue Totem(Rank 5)
		[58649]	  = {1.00, 0, 0}, -- Flametongue Totem(Rank 6)
		[58652]	  = {1.00, 0, 0}, -- Flametongue Totem(Rank 7)
		[58656]	  = {1.00, 0, 0}, -- Flametongue Totem(Rank 8)
	-- Warlock
